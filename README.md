...
2. [Widar 3.0](https://ieee-dataport.org/open-access/widar-30-wifi-based-activity-recognition-dataset): This dataset is a large dataset designed for use in WiFi-based hand gesture recognition.
### Our dataset
